  ...
  return (
    <View style={{backgroundColor: COLOR_WHITE, flex: 1}}>
      ...
      <View style={styles.icon}>
        <Icon
          images={IMAGES.iconCat}
          label="Cat"
          customContainer={styles.iconAir}
        />
        <Icon
          images={IMAGES.iconAir}
          label="Air"
          customContainer={styles.iconAir}
        />
        <Icon
          images={IMAGES.iconListrik}
          label="Listrik"
          customContainer={styles.iconAir}
        />
        <Icon
          images={IMAGES.iconBor}
          label="Bor"
          customContainer={styles.iconAir}
        />
        <Icon
          images={IMAGES.iconToilet}
          label="Toilet"
          customContainer={styles.iconAir}
        />
        <Icon
          images={IMAGES.iconRenov}
          label="Renovasi"
          customContainer={styles.iconAir}
        />
        <Icon
          images={IMAGES.iconKeramik}
          label="Keramik"
          customContainer={styles.iconAir}
        />
        <Icon
          images={IMAGES.iconBangunan}
          label="Bangunan"
          customContainer={styles.iconAir}
        />
      </View>
