  ...
  return (
    <View style={{backgroundColor: COLOR_WHITE, flex: 1}}>
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        <Text style={styles.textHeader}>Detail Feed</Text>
      </View>
      <CardDetailAdmin status={status} person={person} date={date} customCard={styles.cardDetail} />
      <Text style={styles.textTitle}>Foto Feed</Text>
      <Image source={IMAGES.result} style={styles.imgFeed} />
      <CardResult title="Judul" result="Cat Tembok" customCard={styles.result} />
      <CardResult title="Deskripsi" result="Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
      Malesuada morbi tortor orci placerat in viverra. Vel blandit massa rutrum risus faucibus tincidunt. Varius nec accumsan sit amet. Nulla non orci dolor in a adipiscing. Ut augue convallis sed in luctus ut ridiculus mattis porttitor." customCard={styles.result} />
...
export default DetailFeedAdmin;
